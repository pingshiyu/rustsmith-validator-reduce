...
fn fun2(var8: u16, var9: bool) -> Vec<f32> {
    ...
    println!("{:?}", var9);
    vec![
        87961935194000749264336531553617226482u128,
        28106181833151374143449698262913875655u128,
        157110561452632865620542100382940587803u128,
        45631070894136394868144589018154374987u128,
        78325019248207607090587499289661689029u128,
        97566174910760746573166902320059572005u128,
        78385046570816368831406649770152761545u128,
        97168348925786158036578736046771070338u128,
    ]
    .len();
    0.36745172519005875f64;
    var10 = 14019663544867112082u64;
    vec![
        48991956676387189814608081036789260016u128,
        170014676375803831208001000237073340658u128,
        65837072544303230949816928016846757736u128,
    ]
    .len();
    var10 = 18137557378175919137u64;
    var10 = 13971138144422999023u64;
    let mut var15: Vec<u128> = vec![
        4169362625537582407925589292549017745u128,
        77714559604842816727000480435914208970u128,
        125160299652889393244150543015019149873u128,
        40851332193906641514263608365084479795u128,
        33353592912989603835018145510769437698u128,
        46404860717141087876580240385646192657u128,
    ];
...
fn fun5(var41: i32) -> Vec<u128> {
    ...
    (
        3777654625u32,
        6642353104036674904u64,
        vec![
            13972387663010696569u64,
            7450445297925185069u64,
            4221853925767891067u64,
            3962054926025175475u64,
            11813652292474235920u64,
            12627009495002869225u64,
        ],
        119423565572224267608842235669342828866u128,
    );
    println!("{:?}", var46);
    let mut var52: u128 = 78469768657820028947040144985407044666u128;
    let mut var53: Vec<u128> = vec![
        22112611133835788335282152000761323242u128,
        18534409118242677512076494666189358706u128,
        163796110850778141164892169860596749632u128,
        104097371915293891470180506447709602388u128,
        89958109139583151796100921371071988973u128,
    ];
    ...
    vec![
        121325177893988793545996454179236266354u128,
        15987868711306048051025209341313058673u128,
        43539131334295785021258253605441971166u128,
        83364424136328019885490603049480995293u128,
        98815671474657691122936153522962554011u128,
        18615494610077391173750591099750647933u128,
...
fn fun6(var56: i128, var57: f32) -> Vec<f32> {
    let mut var58: (u8, u16, u128, String) = if (true) {
        ...
        vec![
            7502225950972550199940152705536110606i128,
            141527412620241409648419270252583303173i128,
            105004752496553347878266680578126330247i128,
            86602605685225024552518963744331646331i128,
            145475942508064739583063986523332554109i128,
            96425547905583168865488054655056716236i128,
            82247072817938662020076770294511021026i128,
            103424194893895617369888188315215878331i128,
            159392413267226297492836107511890105965i128,
        ]
        .len();
        ...
        println!("{:?}", var57);
        vec![
            95284409047696615158755662776500333762u128,
            128494984960070158458827172122037378594u128,
            106559266820514940352729561790063414487u128,
        ];
        String::from("ZI8mZctPeDebSRSqCGL9FdurcAPWfrF2FyFGIdEXedQwr62NptFcKhGjP6NmsckbMD5Gobg8sENa6TA5owRGIaLXO5SYfCk7Bt8");
        var59 = 81i8;
        String::from(
            "TCoqYITP6R8CzQr67FSQXCIH2c0lv0mBO3xpVQMc2nWAiP4B5KepJBhtGhPa6h5zDOjnA9dKQv0ZzZ",
        );
        return vec![0.81577575f32, 0.24282128f32, 0.6883676f32, 0.72841f32];
        (
            38u8,
            17347u16,
            134490312664375176243251795096934105810u128,
            String::from("zDMmXhRAuHBxuCtI5z9WPT0KwP3NZ0sfHKje0rwSHfE3KaVK9oVNjNqwRDIqSSPOgHHzWZa"),
        )
    } else {
        let mut var61: (u8, u16, u128, String) = (
            215u8,
            48482u16,
            50163222044720275980703254279403295350u128,
            String::from("3OL9mJ3mmyJroYYip"),
        );
        (
            216u8,
            42550u16,
            153918682411057836846186624138123492426u128,
            String::from("FWAtFSP4rn4xLavSR70erEf4cdUllGuKpTlZcQWv"),
        );
        true;
        var61.0 = 141u8;
    ...
    vec![
        11877528719445469324usize,
        10469204524759524228usize,
        3871053430755485948usize,
        13295263602523642673usize,
        2892004171340454592usize,
    ]
    .push(
        vec![
            10674516352141460445usize,
            71166406964537805usize,
            3719723215347603264usize,
            2232920051090542657usize,
        ]
        .len(),
    );
...
fn fun7(var75: bool) -> Vec<i128> {
    ...
    (vec![
        87811943793300268754969976700912426354i128,
        9474927534853040491866661661096298174i128,
    ])
}
...
fn fun9(var80: f64) -> Vec<usize> {
    {
        let mut var81: (u32, u64, Vec<u64>, u128) = (
            1454919714u32,
            15853830477599610994u64,
            vec![
                9134528390376866624u64,
                11164613967174635722u64,
                11208185380591803067u64,
            ],
            68278719770572399128502354393973346617u128,
        );
        ...
        1273249247u32;
        println!("{:?}", var82);
        let mut var83: usize = vec![
            13589268645114240373709588786021707345u128,
            133168646294767922422366175718059902183u128,
            167358495918613143492064879676670527662u128,
            8441094745763365779819237951138096902u128,
        ]
        .len();
        -1870325922i32;
    ...
    println!("{:?}", var80);
    vec![
        7999323098751242974usize,
        14640478032204914689usize,
        vec![14291i16, 27559i16, 14972i16].len(),
        14459370586848163486usize,
        15135149220388348690usize,
    ]
    .push(15353581099738598547usize);
    116659597018459842473443275601284185367u128;
    vec![
        25235i16, 20639i16, 26770i16, 18381i16, 6395i16, 32519i16, 23889i16, 14246i16, 24411i16,
    ]
    .len();
    ...
    return vec![
        vec![
            61499347919995536948166825893074347182i128,
            50754706235834403764635378027905653073i128,
            reconditioned_access!(
                vec![
                    13836431038927634224649135762128460110i128,
                    63114382988477861027377535663738367410i128,
                    6775757486489627084298445509168593840i128,
                    122951747426875214436454175021096111792i128,
                    33733086366775005044801659405847839836i128,
                    29829314656097152084655465073668282780i128,
                    44548710269752310775816565476633152900i128
                ],
                4244982796801304705usize
            ),
            142894442133246969456215566093826814274i128,
            36646943435779100195753709137889797531i128,
            138558127168719618586271560555026859994i128,
            142705484912802211189380747383034485695i128,
            (98648422854318166345717120351804522061i128
                & 75836279754359281777549181675539628297i128),
            95646511760276530111710221732302558657i128,
        ]
        .len(),
        if (true) {
            return vec![14073305079750812392usize];
            vec![
                16077629042917271495usize,
                15905676344340192767usize,
                vec![
                    108942534733525171307962288417205694731i128,
                    81684860190491894054849499007427436652i128,
                    131268066735018737961692056265982309848i128,
                    79342913514437519347488440876209173989i128,
                ]
                .len(),
            ]
        } else {
            ...
            return vec![
                12239843359353122473usize,
                5137351108674930005usize,
                vec![32617078550827283208041273554901013357i128].len(),
            ];
            vec![
                vec![7897i16, 3536i16].len(),
                7228876449878975152usize,
                vec![
                    137621841163515354393168790054706223347u128,
                    80658275409817605998861831021260150655u128,
                ]
                .len(),
                17583969342381756503usize,
                1268431236905475611usize,
                vec![10925i16, 15808i16, 13139i16].len(),
            ]
        }
        .len(),
        vec![31065i16, 30411i16].len(),
        374794496118803299usize,
        10724232630074696808usize,
        6766142685980481355usize,
        vec![
            65405u16, 49644u16, 47832u16, 10642u16, 26688u16, 5414u16, 38639u16,
        ]
        .len(),
        13454171165225673928usize,
        11322471311675639941usize,
    ];
    vec![
        8711941819881569176usize,
        vec![
            14115218503369598168u64,
            11545824259850965001u64,
            6102983313402886849u64,
        ]
        .len(),
    ]
}
...
fn fun10(var100: &i16, var101: f32) -> Box<String> {
    3360150426u32;
    let mut var102: usize = (vec![
        15130041427328123977usize,
        6055524439291741559usize,
        vec![
            19566732294802600666050460028568173582i128,
            125908279417753820715833416460117962400i128,
            129519148999628676730041265506319551956i128,
            66469884641105531926938060273162744151i128,
            38846066995348644165240479330222435169i128,
            60399801161671172348117382436330800396i128,
            24330715962656187348992678900552029414i128,
        ]
        .len(),
        vec![
            20059i16, 32757i16, 32424i16, 23001i16, 2127i16, 16672i16, 9379i16, 6829i16, 10134i16,
        ]
        .len(),
        4316018604817257151usize,
        16016677033042938196usize,
        vec![
            54132754268848040820919197412384766269u128,
            87361683518878328399254924905994139506u128,
            98451489104847497225559284993714138384u128,
            100363434301386541275680808879437833275u128,
            131672231427276776812626550807088444434u128,
            86001420834399713981543453205389237377u128,
            136418365962914623283475803477678566205u128,
            169851519103942440657217658003222936286u128,
            150552913578322776380864755528644155172u128,
        ]
        .len(),
        13562254882468690445usize,
    ])
    .len();
    ...
    var102 = vec![
        0.3672307f32,
        reconditioned_div!(0.38359797f32, 0.5324434f32, 0.0f32),
        0.263825f32,
        0.042862296f32,
        0.48929113f32,
        (0.0016966462f32),
    ...
    15i8;
    vec![
        85331611331290940075624652763346478694i128,
        135911542407446674361531260404436230441i128,
        115691799527317535579666084590207448753i128,
        151825466211525615698163242726979718071i128,
        11445623141204688663719432788181777561i128,
        134674475443852276300294516181706909974i128,
    ]
    .push(142868309383449830747792036226183394421i128);
    var102 = vec![
        136756119369958565131599831583239266566u128,
        120978998657045751724266273276351810991u128,
        11339309311076472886040863540822128542u128,
        152370678955397668043006112858642037233u128,
        154307082713238243686612213239801099604u128,
        133584555239751398115208195217597723513u128,
        37831077559459065265144522939179050695u128,
    ]
    .len();
    println!("{:?}", var110);
    ...
    (
        (Struct1 {
            var12: 83i8,
            var13: 5803846884637210686438484735096394048u128,
            var14: 151u8,
        }),
        12298i16,
        String::from("hmthXF9NlresChoYbKGWeGgNuNTqzfG"),
        String::from("X3TtxnMSJ2tvBAXsw1Omc5u8pCODHRdcXZP8H8ZMSZnDmRGnVX8bDGLcZo94fD8FBxy9RaT"),
        50480u16,
    );
...
fn fun13() -> String {
    ...
    vec![
        153917977804260471708367751929152527805u128,
        30962346655060158207620916313365941821u128,
    ];
...
fn fun11() -> f64 {
    ...
    var169 = 14191u16;
    36970u16;
    let var171: (usize, f64, i8) =
        fun12(-4252233588436384267i64.wrapping_add(7639483337248059006i64));
    if (false) {
        (
            40833u16,
            vec![
                4503751368054727236u64,
                17136180739015299847u64,
                4754007166379468975u64,
                8454122884977401372u64,
                fun3(),
            ],
            (
                188u8,
                ...
                reconditioned_access!(
                    vec![
                        63355612470653320236905364182172346334u128,
                        125397453522349163912688221828575711156u128,
                        33821309541720126339797778365225735295u128,
                        153643361503833052192558147840314223902u128,
                        127980027715901224958597734241323632689u128,
                        150186829950298380418811492690463660558u128
                    ],
                    16696385952910495589usize
                ),
                fun13(),
            ),
        );
        ...
        return 0.4904722597730221f64;
        {
            ...
            vec![
                76943335756143330456599242304677277268i128,
                106358523636955872617657248933476911461i128,
                43207881104346471223145929807341109048i128,
                83943267584152321175533193972799496035i128,
                57310811552569873928196146143056052012i128,
            ]
        }
    } else {
        ...
        vec![
            reconditioned_mod!(
                62687638963244114203561682074520895323i128,
                49305637833171711563600006378138834181i128,
                0i128
            ),
            50612356857876526184919777914906919501i128,
            80590838876188425972348134284696089591i128,
            29921778377105043783224423071165474073i128,
            99045017573764829338859011154493852592i128,
            158590054659808972621618254104218033368i128,
            (85343968476648483911976981703384682141i128
                ^ 58154664558587622246537765626874906559i128),
...
fn fun15(var218: i8, var219: u32) -> Vec<u64> {
    ...
    let mut var220: (u8, u16, u128, String) = (
        68u8,
        29569u16,
        48202500640095376669710835293539883849u128,
        String::from("pQbgwQpv8riUVNIY1ljp5t"),
    );
    var220 = (
        60u8,
        49253u16,
        55555393618967674317657162315071604094u128,
        String::from("jEzhMe8Kx1v2R6gFjAUAE6g1lpwdUAqIICzsJ1QE2RuZy"),
    );
    ();
    6660u16;
    var220 = (
        96u8,
        39545u16,
        126941413883250030898473161176791425712u128,
        String::from("sBzRgq7oaMScc3B"),
    );
    var220.0 = 95u8;
    ...
    vec![
        vec![
            15476229938899641716u64,
            1029291232253169607u64,
            3603929001903552759u64,
            14202205582851137766u64,
            1579816245511963726u64,
            13686823960019281856u64,
            14040135710265812953u64,
            17325353989640643500u64,
        ]
        .len(),
        vec![23492u16, 34061u16].len(),
        vec![
            vec![
                0.96458054f32,
                0.44582027f32,
            ...
            .len(),
            vec![12736277974195883114u64].len(),
            16445992203368816937usize,
            17507509472672095390usize,
            vec![
                59372292925716583449166294244751075191i128,
                117158678452076507067316080931010919225i128,
            ]
            .len(),
            18421009784791412898usize,
        ]
        .len(),
    ]
    .push(
        vec![
            5462u16, 48196u16, 65115u16, 29509u16, 12625u16, 40538u16, 49537u16, 57248u16,
        ]
        .len(),
    );
    ...
    let mut var225: String =
        String::from("glA2uUWpCCH62Se8dLB9YJS5nrUw38dNaaDFbvA40wX1CxJgJQQn4yoNo");
    println!("{:?}", var218);
    println!("{:?}", var220);
    ...
    -2063067620i32;
    vec![
        1345i16, 28995i16, 10612i16, 21061i16, 9315i16, 21572i16, 28516i16, 7786i16, 20860i16,
    ]
    .len();
    let mut var227: i8 = 30i8;
    vec![
        vec![
            34133608897329440662601089584433694391u128,
            10055630316810556229111176547433059172u128,
            66983026092766804105650737397062418914u128,
            79273550621064339886228618662986323629u128,
            68430474901760389478712625749113363755u128,
            132227666689520631295367399282210334129u128,
            165722977516047593765738874980239651639u128,
        ]
        .len(),
        vec![151u8, 51u8, 238u8, 91u8, 70u8, 149u8, 79u8].len(),
        vec![
            5596466857474161348u64,
            3631340507966454438u64,
            12961174299575040272u64,
            13291263655894672427u64,
            13139526408891865769u64,
            4466926328865309628u64,
            10529458113939385231u64,
            3604343000072402334u64,
        ]
        .len(),
        9088526809051798487usize,
        8595270543402288219usize,
        15527699617968208780usize,
        vec![26097i16, 16059i16, 2258i16, 3981i16, 23464i16].len(),
    ]
    .push(17310471150719644522usize);
    40694796726836604766488188370425976446i128;
    var222 = 215u8;
    0.8336781f32;
    vec![
        6574080996522158967usize,
        1252445750339226803usize,
        565346789137933897usize,
    ]
    .len();
    vec![
        4217725304865960043u64,
        1841165581953114552u64,
        15349191625977249778u64,
    ]
}
...
fn fun16(var229: &u128, var230: u8, var231: String, var232: u16) -> i32 {
    ...
    var233 = String::from(
        "iP1DVI50jTvkdZun1HzW2EsPGWwzcarj2psjvBb3WfndbuDlX0y1IyklLcF7IV4QcyXhbSNnFlt0ucohrl",
    );
...
fn fun18(var248: String, var249: i128, var250: i16) -> bool {
    vec![12808770703011640354usize].push(
        vec![
            1982904787i32,
            1642423271i32,
            881453716i32,
            1433794926i32,
            9904584i32.wrapping_mul(944662361i32),
            -1018701466i32,
            291256481i32,
            912429178i32,
            -1838878702i32,
...
fn fun21(var415: i32, var416: &&mut i64, var417: u64) -> f32 {
    ...
    (
        vec![
            49761434046541503801461324783712371604u128,
            25393774890303377075757094906663248294u128,
            12543409234180152714685785103882995797u128,
            73904961694137732711236932048841894707u128,
            159908168739046593320402732050105244787u128,
            66628929456471400191700213345596996477u128,
            5409968380168684768672274089603802151u128,
            30645173934651060638150535289430387451u128,
        ],
        2271017517u32,
        0.6413912645402338f64,
        0.6213299974445425f64,
        12663818018576187333u64,
    )
        .0
        .push(130506251543870367054987565573761913958u128);
    ...
    let mut var435: u128 =
        (24796439368995756088922305859322217955u128 | 61540018506305208580837279526497027102u128);
    11812i16;
    println!("{:?}", var427);
    120i8;
    println!("{:?}", var425);
    1906413904i32;
    vec![12850490427343909371049038881856486733i128]
        .push(13019089592461300524078259132461385993i128);
    *var433 = String::from("MFw5QHaQ6YwC6rtM6aWP");
    *var433 = String::from("WT87Jk1oK6BkC8ss1Z");
    let mut var438: Struct1 = Struct1 {
        var12: 31i8,
        var13: 63004821603296931665696304546557529551u128,
        var14: 178u8,
    };
    println!("{:?}", var417);
    0.70394105f32
...
fn fun20() -> usize {
    ...
    fun18(
        String::from("ot"),
        34348527906663129824361292701146221934i128,
        8700i16,
    );
    ...
    String::from("Rg");
    return vec![
        -436798424i32.wrapping_add(284215922i32),
        -825877338i32,
        -1299161281i32,
        951475139i32,
    ]
...
fn fun24(var562: f64, var563: u32) -> Struct18 {
    ...
    var565 = false;
    return Struct18 {
        var356: 88412649180310637576142759259630457472i128,
        var357: 60u8,
        var358: 36u8,
        var359: 35948u16,
        var360: Struct17 {
            ...
            var354: 27825i16,
            var355: vec![
                135148541798139007243256597540199480597i128,
                33672723527147399527986149428507089027i128,
                130792132712129372216021096461501499221i128,
                148304664626356276862736392558458391051i128,
                136623363502761290482711497909119711112i128,
                68098545039129256350476194060227246825i128,
                148042597002681254387365415843741490144i128,
                68419459020709912830044352745201905870i128,
            ],
        },
    };
    Struct18 {
        var356: 51769210832453633013843001481269932963i128,
        var357: 82u8,
        var358: 36u8,
        var359: 24380u16,
        var360: Struct17 {
            ...
            var354: 25418i16,
            var355: vec![
                102783633573244018400598451398032720204i128,
                159759398952437154792196599975675399782i128,
                31446188028705930774245886243061111500i128,
                160962965370430852946388501210358226712i128,
            ],
        },
    }
}
...
fn fun28(var671: u16, var672: String, var673: bool) -> Vec<u8> {
    ...
    String::from(
        "8r2VABcQtU6EmXh1E9d0RcnXRLvEcfn02chZAiW5WmgG8RDnrFXuIz56ccB2FGP79NF4mXFl4n1CxZ2KbRFMK",
    );
    println!("{:?}", var678);
    println!("{:?}", var674);
    println!("{:?}", var678);
...
fn main() -> () {
    ...
    let var21: u64 = reconditioned_access!(
        vec![
            cli_args[2].clone().parse::<u64>().unwrap(),
            18045704122477463814u64,
            4086969414050386286u64,
            if (cli_args[11].clone().parse::<bool>().unwrap()) {
                ...
                (cli_args[1].clone().parse::<u128>().unwrap()
                    | 106841936989484691424541915587856014970u128);
            ...
            cli_args[2].clone().parse::<u64>().unwrap(),
            cli_args[2].clone().parse::<u64>().unwrap(),
            9116883344396265009u64
        ],
        cli_args[3].clone().parse::<usize>().unwrap()
    );
    let var243: i8 = cli_args[13]
        .clone()
        .parse::<i8>()
        .unwrap()
        .wrapping_mul(fun17(15i8, 18066761363204750082u64, -460942358i32));
    ...
    11299709172979052996usize.wrapping_mul(
        vec![
            ...
            215u8,
            {
                ...
                ();
                println!("{:?}", var243);
                let var291: Vec<i64> = vec![
                    cli_args[10].clone().parse::<i64>().unwrap(),
                    -3749447174926694181i64,
                ];
                ...
                var290 = vec![
                    -8909515614235379750i64,
                    const3,
                    const3,
                    -8406870688930482240i64,
                    8849204805035793426i64,
                    cli_args[10].clone().parse::<i64>().unwrap(),
                ];
                ...
                let var314: usize = vec![
                    cli_args[10].clone().parse::<i64>().unwrap(),
                    cli_args[10].clone().parse::<i64>().unwrap(),
                    cli_args[10].clone().parse::<i64>().unwrap(),
                    -8012184730036338901i64
                        .wrapping_add(cli_args[10].clone().parse::<i64>().unwrap()),
                    3810556429768704456i64,
                    3033570439441556040i64,
                    (cli_args[10].clone().parse::<i64>().unwrap()
                        | cli_args[10].clone().parse::<i64>().unwrap()),
                    cli_args[10].clone().parse::<i64>().unwrap(),
                    3786357767248342618i64,
                ]
                .len();
                let var312: Struct15 = Struct15 {
                    var308: var313,
                    var309: cli_args[9].clone().parse::<u32>().unwrap(),
                    var310: var314,
                    var311: cli_args[7].clone().parse::<f32>().unwrap(),
                };
    ...
    let var318: String = String::from(
        "Jj0H75u7YBK467Jd17XMubyvpyekEBwW9XLZpS0f8zjhAkG7ukYEyMHrSf2AHzzWE7qZzeTA4LrOsd2oemfFSuO",
    );
    let mut var319: Vec<u16> = vec![
        cli_args[15].clone().parse::<u16>().unwrap(),
        53280u16,
        cli_args[15].clone().parse::<u16>().unwrap(),
        cli_args[15].clone().parse::<u16>().unwrap(),
